        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-3">
              <button type="button" className="w-10 h-10 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white rounded-lg flex items-center justify-center transition-all duration-300 border border-white/20 hover:border-white/40" aria-label="Social link">
